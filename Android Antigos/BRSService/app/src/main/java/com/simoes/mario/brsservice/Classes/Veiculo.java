...
public class Veiculo implements Serializable {
    ...
    public Veiculo(String id, String tipo, String marca, String modelo, String combustivel,
                   int ano, int litragem, String oleoMotor, String oleoCambio, String codfOleo, String codfAr, String codfArCab, String codfComb) {
        this.id = id;
        setTipo(tipo);
        setMarca(marca);
        setModelo(modelo);
    ...
    public void setOleoMotor(String oleoMotor) {
        this.oleoMotor = oleoMotor.toUpperCase();
    }
    ...
    public void setOleoCambio(String oleoCambio) {
        this.oleoCambio = oleoCambio.toUpperCase();
    }
