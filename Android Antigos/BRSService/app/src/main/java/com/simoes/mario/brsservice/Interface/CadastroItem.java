...
public class CadastroItem extends AppCompatActivity {
        ...
        spnItemCadMarca.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("Cadastro Item", "Erro no spnIntemCadMarca, message: " + e.getMessage());
                }
            }
    ...
    private void ExecutarFiltro() {
        try {
            ...
            Log.e("Erro ", "Erro no método Executar Filtro, message: " + e.getMessage());
        }
    }
    ...
    private void ExecutarOleo() {
        try {
            ...
            Log.e("Erro ", "Erro no método ExecutarOleo, message: " + e.getMessage());
        }
    }
}
