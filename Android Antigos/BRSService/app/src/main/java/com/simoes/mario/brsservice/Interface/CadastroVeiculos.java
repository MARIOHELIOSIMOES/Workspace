    ...
    ValueEventListener listenerFiltros = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            try {
                ...
                Log.e("Erro!", "Erro no listener Filtros - " + e.getMessage());
            }
            carregarFiltros();
        }
...
//olhar aqui
                ...
                Log.e("Erro!", "Erro no listener Oleos - " + e.getMessage());
            }
            carregarOleos();
        }
...
//        spnOleoDif = (Spinner)findViewById(R.id.spnCadOleoDiferencial);
        ...
        spnMarca.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("SpnMarcas", "Erro no on Item change, message:" + e.getMessage());
                }
        ...
        spnOleoMotor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("Cadastro Veiculo Erro", "spnOleo Motor, message: " + e.getMessage());
                }
            }
        ...
        spnOleoCambio.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("Cadastro Veiculo Erro", "spnOleoCambio, message: " + e.getMessage());
                }
            }
        ...
        spnFiltroCom.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("Cadastro Veiculo Erro", "spnFiltroCom, message: " + e.getMessage());
                }
            }
        ...
        spnFiltroOleo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("Cadastro Veiculo Erro", "spnFiltroOleo, message: " + e.getMessage());
                }
            }
        ...
        spnFiltroAr.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("Cadastro Veiculo Erro", "spnFiltroAr, message: " + e.getMessage());
                }
            }
        ...
        spnFiltroArCab.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Log.e("Cadastro Veiculo Erro", "spnFiltroArCab, message: " + e.getMessage());
                }
            }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    veiculo = new Veiculo();
                    veiculo.setTipo(tipos[spnTipo.getSelectedItemPosition()]);
                    veiculo.setMarca(listAdapMarcas.get(spnMarca.getSelectedItemPosition()));
                    veiculo.setModelo(edtModelo.getText().toString());
                    veiculo.setAno(Integer.parseInt(edtAno.getText().toString()));
                    veiculo.setLitragem(Integer.parseInt(edtLitragem.getText().toString()));
                    veiculo.setCombustivel(combustiveis[spnCombustivel.getSelectedItemPosition()]);

                    veiculo.setOleoMotor(listOleoMotor.get(spnOleoMotor.getSelectedItemPosition() - 1).getModelo());
                    veiculo.setOleoCambio(listOleoCambio.get(spnOleoCambio.getSelectedItemPosition() - 1).getModelo());

                    veiculo.setCodfOleo(listFiltroOleo.get(spnFiltroOleo.getSelectedItemPosition() - 1).getCodigo());
                    veiculo.setCodfAr(listFiltroAr.get(spnFiltroAr.getSelectedItemPosition() - 1).getCodigo());
                    veiculo.setCodfArCab(listFiltroArCab.get(spnFiltroArCab.getSelectedItemPosition() - 1).getCodigo());
                    veiculo.setCodfComb(listFiltroComb.get(spnFiltroCom.getSelectedItemPosition() - 1).getCodigo());

                    fireVeiculo.SalvarNovo(veiculo);
    ...
    private void carregarMarca() {
        try {
            ...
            Log.e("Erro!", "Erro no Método CarregarMarca - " + e.getMessage());
        }
    }
    ...
    private void carregarFiltros() { // terminar de atualizar todos os valores
        try {
            ...
            Log.e("Erro!", "Erro no Método Carregar Filtros - " + e.getMessage());
        }
    }
    ...
    private void CadastrarItem(String operacao, String tipoItem, String filtroCod) {
        try {
            ...
            Log.e("Erro!", "Erro no Método Cadastrar Item- " + e.getMessage());
        }
    }
}
