...
public class Pesquisar extends AppCompatActivity {
    ...
    FloatingActionButton fabOrcamento,fabAlterar, fabExcluir;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAlterar = (FloatingActionButton)findViewById(R.id.fabAlterar);
        ...
        fabExcluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!veiculo.getId().isEmpty()){
                    Snackbar.make(view, "Tem certeza que deseja excluir o veículo?", Snackbar.LENGTH_LONG)
                            .setAction("Sim", new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    try{
                                        ...
                                        fireVeiculo.Excluir(veiculo);
                                        Toast.makeText(Pesquisar.this, "O veiculo foi excluído da base de dados", Toast.LENGTH_LONG).show();
                                        Log.i("PESQUISAR","Veiculo excluido da base");
                                    }catch (Exception e){
                                        Log.e("PESQUISAR","OCORREU UM ERRO AO EXCLUIR O VEICULO");
                                    }
                                }
        ...
        fabAlterar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try{
                    if(!veiculo.getId().isEmpty()){
                        Log.i("PESQUISAR","ATUALIZAR VEICULO, ID ="+ veiculo.getId());
                        Intent i = new Intent(getBaseContext(), CadastroVeiculos.class);
                        i.putExtra(Constantes.VEICULO, veiculo);
                        i.putExtra(Constantes.COD_OPERACAO,Constantes.COD_ATUALIZAR_VEICULO);
                        startActivity(i);
                    }
                }catch (Exception e){
                    Toast.makeText(getBaseContext(),"Não foi possível fazer essa operação. Message: "+e.getMessage(), Toast.LENGTH_LONG).show();
                    Log.e("PESQUISAR", "ERRO NO btnAlterar, message: "+e.getMessage() + ", causa: "+e.getCause());
                }
            }
        });
