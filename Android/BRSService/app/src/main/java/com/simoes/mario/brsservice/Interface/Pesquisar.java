...
public class Pesquisar extends AppCompatActivity {
    ...
    private void carregarTipos() {
        try {
            ...
            Log.e("Erro!", "Erro no Método Carregar tipos- " + e.getMessage());
        }
    }
    ...
    private void carregarMarcas(int indice) {
        ...
        try {
            ...
            Log.e("Erro!", "Erro no Método Carregar Marcas - " + e.getMessage());
        }
    }
    ...
    private void carregarModelo(int indice) {
        try {
            ...
            Log.e("Erro!", "Erro no Método Carregar Modelo - " + e.getMessage());
        }
    }
    ...
    private void carregarCombustiveis(int indice) {
        try {
            ...
            Log.e("Erro!", "Erro no Método Carregar Combustíveis - " + e.getMessage());
        }
    }
    ...
    private void carregarAno(int indice) {
        try {
            ...
            Log.e("Erro!", "Erro no Método Carregar Ano - " + e.getMessage());
        }
    }
}
