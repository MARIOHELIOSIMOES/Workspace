...
//Atividade UNIVESP, Comp. Gráfica, 2019

#include<stdlib.h>
#include<GL/glut.h>

static int gira=0,gX=0,gY=0,gZ = 0;
...
void display(void){
  ...
  /* **************** Chão *********************/
  glPushMatrix();
  glTranslatef (0.0, -3.2, 0.0); // posição na tela (x,z,y)
  glColor3f (corChao[0], corChao[1], corChao[2]); //Definição de Cor do objeto
  glScalef (chao[0], chao[1], chao[2]); // Tamanho do objeto (x, z, y)
  glutSolidCube (1.0); // escala de proporção do objeto
  glPopMatrix();
  /* **************** Fim Chão ***************** */
  ...
  glPushMatrix();
  glColor3f (1,1,1);
  glTranslatef (0.0, quadra[1], 0.0); // posição na tela (x,z,y)
  ...
  glPushMatrix();
  glColor3f (1,1,1);
  glTranslatef (5.5, quadra[1], 0.0); // posição na tela (x,z,y)
  glScalef (1, 0.01, 7.5);
  glutSolidCube (1.0);
  glPopMatrix();
  ...
  glPushMatrix();
  glColor3f (1,1,1);
  glTranslatef (0, quadra[1], 3.75); // posição na tela (x,z,y)
 ...
 /* ***************** Fim Quadra***************** */
  ...
  glTranslatef (0, 0.0, quadra[2]/2); // posição na tela (x,z,y)
 ...
 // glColor3f(corMureta[0],corMureta[1],corMureta[2]);
  glColor3f(1,0,0);
  glTranslatef (quadra[0]/2, 0.0, 0); // posição na tela (x,z,y)
...
/* ***************** Fim Haste 1 ***************** */
  ...
  /* ***************** Texto de Identificação do Autor *****************  */
    ...
    /* ***************** FIM -Texto de Identificação do Autor *****************  */
