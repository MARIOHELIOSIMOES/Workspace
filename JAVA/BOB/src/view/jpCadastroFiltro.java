 ...
 * @author mario
 */
public class jpCadastroFiltro extends javax.swing.JPanel {
    ...
    private void preencherCbbTipo(){
        ...
        cbbTipo.addItem(Item.TIPO_STRING[Item.FILTRO_AR]);
        cbbTipo.addItem(Item.TIPO_STRING[Item.FILTRO_COMBUSTIVEL]);
        cbbTipo.addItem(Item.TIPO_STRING[Item.FILTRO_OLEO_MOTOR]);
        cbbTipo.addItem(Item.TIPO_STRING[Item.PU]);
        tipos = new int[4];
        tipos[0]=Item.FILTRO_AR;
        tipos[1]=Item.FILTRO_COMBUSTIVEL;
        tipos[2]=Item.FILTRO_OLEO_MOTOR;
        tipos[3]=Item.PU;
    }
...
//        arraylist = new ItemControl().getArrayListItem();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/filtro.png"))); // NOI18N
        jLabel1.setText("Cadastro de Filtros");
